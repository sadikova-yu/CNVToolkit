...
with open('/home/onco-admin/ATLAS_software/aod-pipe/Pipe/AODCNV/config/AODABCV1/cov_average_coef_Ion.csv', 'w') as outf:
	outf.write('### median normalized coverage (count/total counts) per loci over all sample (script for calculation here)\n')

sample_list=[]
with open('/home/onco-admin/ATLAS_software/aod-pipe/Pipe/AODCNV/test/list_it_qc_pass', 'r') as outf:
	for line in outf:
		line=line.strip()
...
for p in ['pool_1', 'pool_2']:
	...
	with open('/home/onco-admin/ATLAS_software/aod-pipe/Pipe/AODCNV/config/AODABCV1/cov_average_coef_Ion.csv', 'a') as outf:
